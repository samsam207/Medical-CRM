...
def broadcast_new_checkin(clinic_id, visit_data):
    """Broadcast new check-in to all clients in clinic room"""
    socketio.emit('new_checkin', visit_data, room=f'clinic_{clinic_id}')

def broadcast_visit_status_change(clinic_id, visit_data):
    """Broadcast visit status change to all clients in clinic room"""
    socketio.emit('visit_status_changed', visit_data, room=f'clinic_{clinic_id}')
